...
Public Class clsimprimeformato
    ...
    Public Sub imprimeencabezado(ByVal imprimohistorial As Boolean, ByVal _formato As String, reimpresion As Boolean)
                ...
                Try
                    ...
                    Try
                        Select Case tipocampo
                            ...
                            Case "Fecha"
                                mensaje = Now.Date.ToString("dd/M/YYYY")
                                'Case "CampoFolio"
