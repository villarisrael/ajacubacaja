...
Public Class Frmlistadofacturas
    ...
    Private Sub btncargar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncargar.Click
        Try
            ...
            If txtCaja.Text = "" Then
                bas.llenaGrid(dataGridView1, "select fecha, serie, CuentaDatosFiscales, numero, nombre,  Subtotal,IVA, Total, Estado, case when tipo=1 then 'USUARIO' when tipo=0 then 'CLIENTE' when tipo=2 then 'CLIENTE' WHEN tipo=3 then 'FACTIBILIDAD' WHEN tipo=4 then 'PERIODO'  end as Es,MOTIVOCANCELACION,recibo, serierecibo,UUID, Acuse_Cancelacion from encfac where fecha between '" & dtinicio.Value.ToString("yyyy-MM-dd") & " 00:00:01' and '" & dtfinal.Value.ToString("yyyy-MM-dd") & " 23:59:59' order by numero;")
            Else
    ...
    Private Sub btncancelarrecibo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncancelarrecibo.Click
        ...
        If resultfacturas = DialogResult.OK Then
            ...
            Dim tipoFacturaUsuario = ConvertirTipoUsuario(tipo)



            If My.Settings.ProvedorFacturacion = "MULTIFACTURAS" Then

                conectar()


                If tipoFacturaUsuario = 1 Or tipoFacturaUsuario = 2 Or tipoFacturaUsuario = 3 Then
                            ...
                            Try
                                ...
                                If estatusRecibo = "A" Then
                                    ...
                                    Catch ex As Exception
                                        ...
                                        MessageBox.Show($"Ocurrio un error al actualizar la fecha de deuda del usuario: {cuenta}")
                ...
                ElseIf tipoFacturaUsuario = 4 Then

                    Try

                        Ejecucion($"UPDATE PAGOS SET Facturado=0, SERIEFACTURA = '' WHERE FACTURADO = {factura} AND SERIEFACTURA = '{serie}'")

                        Ejecucion($"Update encfac set ESTADO='C' WHERE NUMERO={factura} and serie ='{serie}'")

                        MessageBox.Show($"FACTURA:{serie} {factura} CANCELADA CON EXITO EN SISTEMA, SE HAN RESTURADO LOS RECIBOS")

                    Catch ex As Exception

                        MessageBox.Show($"OCURRIO UN ERROR AL RESTAURAR LOS RECIBOS: {ex.ToString()}")
    ...
    Private Sub btnreimprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreimprimir.Click
        ...
        Dim cuentaFactura_DFiscales As String = dataGridView1.Item("CuentaDatosFiscales", dataGridView1.CurrentRow.Index).Value.ToString()
        ...
        Select Case tipo.ToUpper
            Case "USUARIO", "NO USUARIO", "FACTIBILIDAD"
                ...
                If datosfac.Read Then
                    ...
                    ElseIf datosfac("version") = "4.0" Then
                        ...
                        objFactura.GenerarPDFFactura_CFDI4(serie, factura, cuenta, True, tipoFacturaUsuario, False)
            ...
            Case "PERIODO"
                ...
                objComplemento.GenerarPDFFactura_CFDI4(serie, factura, cuenta, True, tipoFacturaUsuario, False)
