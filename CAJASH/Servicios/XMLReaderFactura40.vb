...
Public Class XMLReaderFactura40
    ...
    Public Sub CrearArchivoXML(serieFacturaP As String, folioFacturaP As String, rutaDirectorio As String)



        Dim cadenaxml3 = (rutaDirectorio & "\xmlFactura" & serieFacturaP & folioFacturaP & ".xml").Trim
